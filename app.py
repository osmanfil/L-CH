...
"""  # <--- HTML kodunun bittiği en alt satıra bu üçlü tırnağı eklemelisin!
    ...
    <style>
        ...
        * {
        ...
        .ttt-cell { background-color: var(--bg-card); border: 1px solid var(--border-color); border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 26px; font-weight: bold; cursor: pointer; height: 85px; width: 85px; }
